...
namespace OnlineMaps
{
    ...
    /// </summary>
    [AddComponentMenu("Infinity Code/Online Maps/Third-Party Connectors/Real World Terrain Connector")]
    [ThirdPartyPlugin("Real World Terrain Connector", typeof(ControlBase))]
    public class RealWorldTerrainConnector : MonoBehaviour, ISavable
    {
        /// <summary>
        /// Connection mode
        /// </summary>
        ...
        private void Start()
        {
            ...
            {
                marker = Marker2DManager.CreateItem(currentPosition, markerTexture, markerLabel);
            }
        }
